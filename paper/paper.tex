...
\IfFileExists{figures/real_robot_tabletop.pdf}{%
  \includegraphics[width=0.96\linewidth,height=1.8cm,keepaspectratio]{figures/real_robot_tabletop.pdf}%
}{%
  \fbox{\parbox[c][1.55cm][c]{0.94\linewidth}{\centering\footnotesize
...
diagnostic. Exact paired interventions on hardware remain the next validation
step; the reserved tabletop experiment is intended to test this transfer
without changing the paper's primary claim.
...
does not serve as a broad manipulation benchmark.
